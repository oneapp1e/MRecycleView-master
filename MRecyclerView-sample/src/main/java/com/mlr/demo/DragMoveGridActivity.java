...
import com.mlr.demo.adapter.DragMoveGridAdapter;
...
public class DragMoveGridActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DragMoveGridAdapter commonListAdapter = new DragMoveGridAdapter(this, list);
        //启动到底了试图
